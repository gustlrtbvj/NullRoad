			...
			<div class="section-box first">
				...
				<table class="board-form">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="title2" style="width: 748px;"></td>
						...
						<tr>
							...
							<td><textarea id="content" name="content2" rows="10"
									cols="90" style="width: 748px; height: 286px;"></textarea>
									 <input value="m_id 2" name="writer" style="display: none"></td>
						</tr>
				...
				<div class="btn-wrap" style="text-align: right;">
					<div class="container-login100-form-btn">
						<input id="alertStart" class="login100-form-btn" style="color: #fff" type="submit" value="작성하기">
