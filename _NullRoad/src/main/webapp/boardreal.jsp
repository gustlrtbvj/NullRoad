		...
		<header class="header-section clearfix">
			<div class="container-fluid">
				<a href="main.jsp" class="site-logo" style="font-family: ImcreSoojin; font-size:40px;">
					...
					<a href="login.jsp?page=boardreal.jsp" class="user" style="margin-top: 10px;"><i class="fa fa-user"></i></a>
					<a href="login.jsp?page=boardreal.jsp" class="site-btn">로그인</a>
					<%}else{ %> 
					<div class="responsive-bar" style="margin-top: 10px;"><i class="fa fa-bars" ></i></div>
					<a href="Logout.do?page=boardreal.jsp" class="user" style="margin-top: 10px;"><i class="fa fa-user"></i></a>
					<a href="Logout.do?page=boardreal.jsp" class="site-btn">로그아웃</a>
					<%} %>
					<nav class="main-menu">
						<ul class="menu-list">
							<div class="dropdown">
...
<div id="bo_list" style="width:95%">
    ...
    <div class="bo_reslist">
        <ul>
                ...
                <div class="s-subject" style="padding-left:0px">
                    <div class="bo_tit">[프로젝트]멈쵸!!! 집에가쟈!!!</div>
                </div>
                <div class="s-right">
                    <div class="s-user"><span class="sv_member">관리자</span></div>
        ...
        <div class="bo_fx">
            ...
            <li><a href="write.html" class="btn_b03 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a></li>        </ul>	
            </div>
    ...
    <div class="paginate" style="text-align:center; letter-spacing:10px;">
        <p>&nbsp;</p>
        <span class="num">
            <strong class="s-active" title="현재위치">1</strong>
            <a href="#">2</a>
            <a href="#">3</a>
            <a href="#">4</a>
            <a href="#">5</a>
