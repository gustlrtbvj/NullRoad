...
%>
	...
	<header class="header-section clearfix">
		<div class="container-fluid">
			...
			<a href="login.jsp?page=updateFreeboard.jsp" class="user" style="margin-top: 10px;"><i class="fa fa-user"></i></a>
			<a href="login.jsp?page=updateFreeboard.jsp" class="site-btn">로그인</a>
			<%}else{ %> 
			<div class="responsive-bar" style="margin-top: 10px;"><i class="fa fa-bars" ></i></div>
			<a href="Logout.do?page=updateFreeboard.jsp" class="user" style="margin-top: 10px;"><i class="fa fa-user"></i></a>
			<a href="Logout.do?page=updateFreeboard.jsp" class="site-btn">로그아웃</a>
			<%} %>
